...
import { UserPlus, Loader2, Zap, User, Mail, Lock, CheckCircle, ArrowRight, ArrowLeft } from 'lucide-react';
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 transform hover:scale-[1.01] transition-all duration-300">
                    <div className="mb-8">
                        ...
                        <p className="text-gray-600 dark:text-gray-300">Preencha os dados abaixo para começar</p>
                    </div>
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                        <Link to="/login" className="inline-flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 transition-colors">
